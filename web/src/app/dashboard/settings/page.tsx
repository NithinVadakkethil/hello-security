...
import { Settings, Moon, Sun, Bell, ShieldAlert } from 'lucide-react';
      ...
      <div className="glass-card" style={{ padding: '32px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingBottom: '16px', borderBottom: '1px solid var(--border-color)' }}>
            <div>
              <h4 style={{ fontWeight: 600, fontSize: '0.95rem', margin: '0 0 4px 0', display: 'flex', alignItems: 'center', gap: '8px' }}>
                {theme === 'light' ? <Sun size={16} /> : <Moon size={16} />}
                <span>Active Portal Theme</span>
              </h4>
              <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', margin: 0 }}>Configure light or dark theme view preferences</p>
            </div>
            <button onClick={toggleTheme} className="btn btn-secondary" style={{ padding: '8px 16px', cursor: 'pointer' }}>
          ...
          <div style={{ paddingBottom: '16px', borderBottom: '1px solid var(--border-color)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              ...
              <h4 style={{ fontWeight: 600, fontSize: '0.95rem', margin: 0 }}>System Notifications</h4>
            </div>
            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '12px' }}>Receive real-time alerts for system events and logs</p>
            <Switch
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              ...
              <h4 style={{ fontWeight: 600, fontSize: '0.95rem', margin: 0 }}>Security Session Timeout</h4>
            </div>
            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '12px' }}>Define maximum inactive period before automatic logout</p>
            <Select
